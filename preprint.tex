...
\begin{document}
   ...
   \end{itemize}
	...
	We will now describe the likelihood function of our model, used for parameter estimation by maximum likelihood and as the basis of the statistical tests. It has one term for each of the quantities predicted in the section \nameref{subsec:model_param}: the exonic reads, the intronic reads, and the shape of the intron coverage.
...
% TODO (next): bin centers $x_j$; rescaling of \eqref{eq:p_unspliced} and \eqref{eq:p_nascent}
% to relative coordinates, giving $p_i(x) = 1 + \pi_i (1 - 2x)$; then the three likelihood terms.
% ============================================================================
